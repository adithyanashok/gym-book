...
import { ApiResponse, GetMembersParams, Member, MemberData } from '@/types/member.types';
...
export const createMember = createAsyncThunk(
  ...
  async (body:{memberData: MemberData, fileData:FormData}, { rejectWithValue }) => {
    try {
...
export const renewMemberPlan = createAsyncThunk(
  ...
  async (body:{id:number, planId:number, startDate:Date}, { rejectWithValue }) => {
    try {
...
export const editMember = createAsyncThunk(
  'members/editMember',
  async ({ id, memberData }: { id: number; memberData: MemberData }, { rejectWithValue }) => {
    try {
...
const membersSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchMembers.fulfilled, (state, action: PayloadAction<ApiResponse<Member[]>>) => {
      ...
      .addCase(createMember.fulfilled, (state, action: PayloadAction<ApiResponse<Member>>) => {
      ...
      .addCase(getMemberById.fulfilled, (state, action: PayloadAction<ApiResponse<Member>>) => {
      ...
      .addCase(renewMemberPlan.fulfilled, (state, action: PayloadAction<ApiResponse<Member>>) => {
      ...
      .addCase(editMember.fulfilled, (state, action: PayloadAction<ApiResponse<Member>>) => {
      ...
      .addCase(addMemberImage.fulfilled, (state, action: PayloadAction<ApiResponse<Member>>) => {
        state.createLoading = 'succeeded';
        state.error = null;
        // state.items.unshift(action.payload.data);
      })
...
export const selectMembersLoading = (state: RootState) => state.members.fetchLoading;
...
export const selectMemberLoading = (state: RootState) => state.members.getByIdLoading;
export const selectMemberError = (state: RootState) => state.members.error;

export const selectMemberCreateLoading = (state: RootState) => state.members.createLoading;
