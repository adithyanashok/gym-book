...
const statisticsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(
        getPlanDistribution.fulfilled,
        (state, action: PayloadAction<PlanDistribution[]>) => {
      ...
      .addCase(
        getMonthlyRevanues.fulfilled,
        (state, action: PayloadAction<RevanueData>) => {
...
export const selectedPlanDistribution = (state: RootState) =>
  state.statistics.planDistribution;
export const selectPlanDistributionLoading = (state: RootState) =>
  state.statistics.planDistributionLoading;
export const selectPlanDistributionError = (state: RootState) =>
  state.statistics.error;

export const selectedRevanue = (state: RootState) =>
  state.statistics.revanueData;
export const selectedRevanueLoading = (state: RootState) =>
  state.statistics.revenueLoading;
export const selectedRevanueError = (state: RootState) =>
  state.statistics.error;
